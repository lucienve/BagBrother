...
L.NumWithdraw = '%s Withdraw'
L.NumDeposit = '%s Deposit'
L.NumRemaining = '%s Remaining'
...
L.ReverseSorting = 'Reverse Order'
L.NewSortAlgo = 'New Sort Algo'
L.KeepEmptySlots = 'Keep Empty Slots'
