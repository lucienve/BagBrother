...
L.Locked = '锁定框架'
L.FlashFind = '闪烁搜索'
L.FlashFindTip = '如果启用，Alt+点击一个物品会闪烁所有框体中拥有该物品的格子。'
L.Tooltips = '鼠标提示'

-- frame options
L.FrameOptions = '框架设置'
L.FrameOptionsDescription = '此配置设置特定到一个%s框架。'
...
-- slot options
L.SlotOptions = '颜色设置'
L.SlotOptionsDescription = '此设置允许更改物品在%s框架上的染色以便于识别。'
...
L.DisplayOptionsDescription = '此设置允许配置游戏事件时自动打开或关闭背包。'
